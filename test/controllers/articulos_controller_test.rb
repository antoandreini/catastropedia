...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post articulos_url, params: { articulo: { altimg: @articulo.altimg, contenido: @articulo.contenido, fecha: @articulo.fecha, imagen: @articulo.imagen, titulo: @articulo.titulo } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { altimg: @articulo.altimg, contenido: @articulo.contenido, fecha: @articulo.fecha, imagen: @articulo.imagen, titulo: @articulo.titulo } }
